...
public class ClientPropertyListAdapter extends RecyclerView.Adapter<ClientPropertyListAdapter.MyViewHolder> {

    ProgressDialog progressDialog;
    private List<ClientPropertyModel> clientpropertyList;
    private Context mCtx;


    public ClientPropertyListAdapter(Context baseContext, List<ClientPropertyModel> clientpropertyList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ClientPropertyModel c = clientpropertyList.get(position);
        holder.cpropertyid.setText(String.valueOf(c.getCPropertyID()));
        ...
        holder.createdon.setText(String.valueOf(c.getCreatedOn()));
    ...
    public int getItemCount() {
        ...
        return clientpropertyList.size();
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_clientpropertylist, parent, false);
